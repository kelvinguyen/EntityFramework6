...
namespace NameSearch.DataContext.PersonDataSeed
{
        ...
        public static List<Person> CreateMultiplePerson()
        {
            ...
            var list = new List<Person>
            {
                DataSeed.CreatePerson("Micheal","Jackson",imgurl,
                     DataSeed.CreateAddressList(),DataSeed.CreateInterestList(),23),
                DataSeed.CreatePerson("Bruce","Lee",imgurl,
                        DataSeed.CreateAddressList(),DataSeed.CreateInterestList(),34),
                DataSeed.CreatePerson("Bon","Jovi",imgurl,
                        DataSeed.CreateAddressList(),DataSeed.CreateInterestList(),45),
                DataSeed.CreatePerson("Jackie","Chan",imgurl,
                        DataSeed.CreateAddressList(),DataSeed.CreateInterestList(),56),
                DataSeed.CreatePerson("Tom","Cruise",imgurl,
                        DataSeed.CreateAddressList(),DataSeed.CreateInterestList(),67),
            };
            return list;
        }
        public static Person CreatePerson(string first, string last,
                string img, List<Address> addresses, List<Interest> interests, int age)
        {
